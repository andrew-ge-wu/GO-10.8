...
DlgImgLinkTab		: "Länk",
DlgImgUploadImage	: "Infoga bild",
DlgImgUploadImageV	: "Ladda upp en bild från din dator",
DlgImgAddWebImage	: "Eller länka till en bild på internet",
DlgImgAccept		: "Jpg och png-bilder accepteras, 700kB maximal storlek",
...
// Blog image upload
BlogImageUploadPrefix                   : "Fel under bilduppladdning: ",
BlogImageUploadBadInput                 : "felaktig eller saknad användardata!",
BlogImageUploadPermissionDenied         : "åtkomst nekad!",
BlogImageUploadImageTooLarge            : "bilden är för stor!",
BlogImageUploadInvalidFileExtension     : "ogiltig filändelse!",
BlogImageUploadServerError              : "server-fel! Var vänlig försök igen senare.",
BlogImageUploadUnknownError             : "okänt fel!"
};
